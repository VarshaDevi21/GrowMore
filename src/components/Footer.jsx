...
import { Bot, Mail, MapPin, ArrowRight, MessageSquare } from 'lucide-react';
  ...
  return (
    <footer className="border-t-2 border-[#E2D9C8] bg-[#F5EFE0] pt-16 pb-12 text-[#050E1A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main 4-Column Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-[#E2D9C8]">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs font-semibold text-[#334155]">
                  AI Interview Agent · 31-Day Cohort Evaluation
                </span>
              </div>
            </div>

            <p className="text-xs sm:text-sm text-[#1E293B] max-w-md leading-relaxed font-medium">
              An adaptive AI evaluation platform that understands what you built, probes your technical depth with 10 targeted questions, and delivers actionable diagnostic feedback.
            </p>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#FFFFFF] border border-[#E2D9C8] text-xs font-mono text-[#050E1A] font-semibold shadow-sm">
              ...
              <span>Telemetry Active · 31-Day Curriculum Grounded</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <ul className="space-y-2.5 text-xs text-[#334155] font-medium">
              <li className="flex items-center gap-2">
                ...
                <span className="font-semibold text-[#050E1A]">support@growmore.ai</span>
              </li>
              <li className="flex items-center gap-2">
                <MessageSquare className="w-4 h-4 text-[#071426] shrink-0" />
                <span>Cohort Evaluation Helpdesk</span>
              </li>
              <li className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-[#071426] shrink-0" />
                <span>31-Day AI Engineering Cohort</span>
              </li>
            </ul>
          </div>

          {/* Column 4: Socials & Community (2 cols) */}
          <div className="lg:col-span-2 space-y-3">
            <span className="text-xs font-mono uppercase tracking-wider text-[#050E1A] font-extrabold block">
              Follow & Connect
            </span>
            <div className="flex flex-col space-y-2 text-xs font-semibold text-[#334155]">
              {socials.map((social) => (
                <a
                  ...
                  className="flex items-center gap-2.5 hover:text-[#050E1A] hover:underline transition-colors"
                >
                  <div className="w-6 h-6 rounded-lg bg-[#FFFFFF] border border-[#E2D9C8] flex items-center justify-center text-[#071426] shadow-sm">
                    {social.icon}
                  </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-[#475569]">
